...
public class UsuarioController extends org.loja.model.Controller<Usuario> {
  ...
  public void toggle_credencial(@RequestParam("usuario_id") Integer usuario_id, @RequestParam("credencial_id") Integer credencial_id, @RequestParam(value="dataExpiracao", required=false) java.util.Date dataExpiracao) {
    this.serv.toggle_credencial(usuario_id, credencial_id, dataExpiracao);
  }
