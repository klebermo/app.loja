...
insert into usuario_credencial (fk_usuario, fk_credencial) values (1,1);
insert into usuario_credencial (fk_usuario, fk_credencial) values (1,2);
insert into usuario_credencial (fk_usuario, fk_credencial) values (1,3);
insert into usuario_credencial (fk_usuario, fk_credencial) values (1,4);
insert into usuario_credencial (fk_usuario, fk_credencial) values (1,5);
insert into usuario_credencial (fk_usuario, fk_credencial) values (1,6);
insert into usuario_credencial (fk_usuario, fk_credencial) values (1,7);
insert into usuario_credencial (fk_usuario, fk_credencial) values (1,8);
insert into usuario_credencial (fk_usuario, fk_credencial) values (1,9);
